...
namespace WiserHeatApiV2
	...
	/// <see cref="Constants.TextUnknown"/> and numeric properties return 0. IPv4 details are exposed;
	...
	public class WiserNetwork
		...
		/// </summary>
		/// <value>
		/// A string such as "Client" (DHCP) or "Static". Returns <see cref="Constants.TextUnknown"/> if not provided.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The hub hostname, or <see cref="Constants.TextUnknown"/> if not provided.
		/// </value>
		...
		/// otherwise, it is read from the static interface configuration. Returns <see cref="Constants.TextUnknown"/> if unavailable.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The MAC address string reported by the hub, or <see cref="Constants.TextUnknown"/> if not provided.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The security mode string (for example, "WPA2"), or <see cref="Constants.TextUnknown"/> if not provided.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The SSID string, or <see cref="Constants.TextUnknown"/> if not provided.
		/// </value>
