...
Regression coverage uses a synthetic transport and checks readings, commands, limits, differences, Off values, unit changes, schedule import/export and preservation of raw values. No live heating commands are needed for these checks. Optional build-symbol models and downstream UI ranges still require review before release.
