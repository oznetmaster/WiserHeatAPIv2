...
internal static class WindowPlacement
	...
	public static void Restore (Window window)
		...
		try
			...
			Bounds? b = JsonSerializer.Deserialize<Bounds> (json);
			if (b == null)
				return;
			...
			if (left < vLeft || left > vLeft + vWidth - 50)
				left = vLeft + 100;
			if (top < vTop || top > vTop + vHeight - 50)
				top = vTop + 100;
	...
	public static void Save (Window window)
		...
		try
			...
			var json = JsonSerializer.Serialize (b, _options);
